const paths = {
  ...
  hide: ['M3 3l18 18', 'M10.6 6.2c.5-.1.9-.2 1.4-.2 6 0 9.5 6 9.5 6a18 18 0 0 1-3.2 3.8', 'M6.1 6.1C3.8 7.8 2.5 12 2.5 12s3.5 6 9.5 6c1.4 0 2.7-.3 3.8-.8', 'M9.9 9.9a3 3 0 0 0 4.2 4.2'],
